...
describe("Liquid Glass physics contract", () => {
  ...
  it("uses material focus instead of system-blue or hard white rings", () => {
    ...
    expect(tokens).toContain("--lg-control-focus-fill: rgba(255, 255, 255, 0.54)");
    expect(tokens).toContain("--lg-control-focus-surface: rgba(255, 255, 255, 0.66)");
    expect(tokens).toContain("--lg-control-focus-surface-strong: rgba(255, 255, 255, 0.74)");
    ...
    expect(tokens).toContain("--lg-control-focus-fill: rgba(244, 249, 255, 0.6)");
    expect(tokens).toContain("--lg-control-focus-surface: rgba(247, 251, 255, 0.84)");
    expect(tokens).toContain("--lg-control-focus-surface-strong: rgba(248, 251, 255, 0.96)");
    expect(tokens).toContain("--lg-control-focus-depth: rgba(190, 216, 245, 0.09)");
    expect(tokens).toContain("--lg-control-focus-mist: rgba(255, 255, 255, 0.44)");
  ...
  it("captures real idle and focused screenshots for every focus material audit target", () => {
    ...
    expect(verifyLiquidBehaviorSource).toContain("minimumFocusedScreenshotLuma: 198");
    expect(verifyLiquidBehaviorSource).toContain("minimumFocusedMaterialAlpha: 0.86");
    expect(verifyLiquidBehaviorSource).toContain("maximumFocusedMaterialAlpha: 0.98");
