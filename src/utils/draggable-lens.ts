...
export function resolveLensDropletResponse({
  ...
  const scaleX =
    phase === "dragging"
      ? 1.04 + horizontalPull * 0.006 + verticalPull * 0.002
      : 1.107 + horizontalPull * 0.014 + verticalPull * 0.006;
  const scaleY =
    phase === "dragging"
      ? 0.966 + verticalPull * 0.012 + horizontalPull * 0.004
      : 0.969 + verticalPull * 0.006 + horizontalPull * 0.003;
