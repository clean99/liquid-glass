...
const categoryChecks = [
  ...
  },
  {
    ...
    checks: [
      ...
      exists("docs/components/accordion.md"),
      exists("docs/components/alert.md"),
      exists("docs/components/alert-dialog.md"),
      exists("docs/components/avatar.md"),
      exists("docs/components/badge.md"),
      exists("docs/components/breadcrumb.md"),
      exists("docs/components/button.md"),
      exists("docs/components/button-group.md"),
      exists("docs/components/calendar.md"),
      exists("docs/components/card.md"),
      exists("docs/components/checkbox.md"),
      exists("docs/components/combobox.md"),
      exists("docs/components/date-picker.md"),
      exists("docs/components/field.md"),
      exists("docs/components/dialog.md"),
      exists("docs/components/dropdown-menu.md"),
      exists("docs/components/input.md"),
      exists("docs/components/input-group.md"),
      exists("docs/components/input-otp.md"),
      exists("docs/components/label.md"),
      exists("docs/components/native-select.md"),
      exists("docs/components/radio-group.md"),
      exists("docs/components/searchbox.md"),
      exists("docs/components/select.md"),
      exists("docs/components/slider.md"),
      exists("docs/components/sidebar.md"),
      exists("docs/components/switch.md"),
      exists("docs/components/tabs.md"),
      ...
      fileIncludes("docs/components/accordion.md", "registry/components/liquid-accordion.json"),
      fileIncludes("docs/components/alert.md", 'role="status"'),
      fileIncludes("docs/components/alert-dialog.md", 'role="alertdialog"'),
      fileIncludes("docs/components/avatar.md", "LiquidAvatarFallback"),
      fileIncludes("docs/components/badge.md", "LiquidBadgeVariant"),
      fileIncludes("docs/components/breadcrumb.md", 'aria-current="page"'),
      fileIncludes("docs/components/button.md", "registry/components/liquid-button.json"),
      fileIncludes("docs/components/button-group.md", 'role="group"'),
      fileIncludes("docs/components/calendar.md", "DayPickerProps"),
      fileIncludes("docs/components/checkbox.md", "input[type=checkbox]"),
      fileIncludes("docs/components/combobox.md", 'role="combobox"'),
      fileIncludes("docs/components/date-picker.md", "LiquidDatePickerRangeProps"),
      fileIncludes("docs/components/dialog.md", "aria-labelledby"),
      fileIncludes("docs/components/dropdown-menu.md", 'role="menuitem"'),
      fileIncludes("docs/components/input.md", "LiquidInputSurfaceProps"),
      fileIncludes("docs/components/input-group.md", "lg-input-group__inner"),
      fileIncludes("docs/components/input-otp.md", "one-time-code"),
      fileIncludes("docs/components/label.md", "LabelHTMLAttributes"),
      fileIncludes("docs/components/native-select.md", "SelectHTMLAttributes"),
      fileIncludes("docs/components/radio-group.md", "LiquidRadioGroupOption"),
      fileIncludes("docs/components/searchbox.md", "Kube reference contract"),
      fileIncludes("docs/components/select.md", "LiquidNativeSelectProps"),
      fileIncludes("docs/components/slider.md", "input[type=range]"),
      fileIncludes("docs/components/sidebar.md", "LiquidSidebarProvider"),
      fileIncludes("docs/components/switch.md", 'role="switch"'),
      fileIncludes("docs/components/tabs.md", 'role="tablist"'),
      fileIncludes("docs/components/textarea.md", "LiquidTextareaProps"),
      fileIncludes("docs/components/toggle.md", "aria-pressed"),
      fileIncludes("docs/components/toggle-group.md", "LiquidSegmentedControlProps"),
      exists("llms.txt"),
      ...
      fileIncludes("docs/progress-checkpoints.md", "pnpm audit:launch"),
      fileIncludes("docs/progress-checkpoints.md", "pnpm --silent audit:launch:json"),
      ...
      fileIncludes("docs/release-evidence.md", "CHECK_REMOTE_LAUNCH=1"),
  ...
  },
  {
    ...
    checks: [
      ...
      scriptIncludes("ci", "pnpm test:launch-readiness"),
      scriptIncludes("ci", "pnpm test:release-readiness"),
      scriptIncludes("test:launch-readiness", "scripts/audit-launch-readiness.mjs"),
      scriptIncludes("audit:launch", "scripts/audit-launch-readiness.mjs"),
      scriptIncludes("audit:launch:json", "--json"),
      scriptIncludes("verify", "pnpm test:kube-reference:strict"),
      workflowIncludes("ci.yml", 'node-version: "24"'),
      workflowIncludes("ci.yml", "pnpm test:launch-readiness"),
