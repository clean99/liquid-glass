...
- Full written component pages: Provider, Surface, Button, Card, Field, Dialog.
...
| ------------------------ | ----------------- | ------------ | -------------- | ------------------------------------------- | -------------------------------------------- | ------------------------------------------------- | --------------------------- |
| `LiquidAccordion`        | `accordion`       | `disclosure` | `disclosure`   | `src/components/LiquidAccordion.tsx`        | `stories/LiquidAccordion.stories.tsx`        | `registry/components/liquid-accordion.json`       | Storybook + inventory       |
...
| `LiquidCheckbox`         | `checkbox`        | `control`    | `control`      | `src/components/LiquidCheckbox.tsx`         | `stories/LiquidFoundation.stories.tsx`       | `registry/components/liquid-checkbox.json`        | Storybook + inventory       |
...
| `LiquidCombobox`         | `combobox`        | `control`    | `control`      | `src/components/LiquidCombobox.tsx`         | `stories/LiquidCommand.stories.tsx`          | `registry/components/liquid-combobox.json`        | Storybook + inventory       |
...
| `LiquidDatePicker`       | `date-picker`     | `date-time`  | `date-time`    | `src/components/LiquidDatePicker.tsx`       | `stories/LiquidDatePicker.stories.tsx`       | `registry/components/liquid-date-picker.json`     | Storybook + inventory       |
...
| `LiquidDropdownMenu`     | `dropdown-menu`   | `overlay`    | `overlay`      | `src/components/LiquidDropdownMenu.tsx`     | `stories/LiquidOverlay.stories.tsx`          | `registry/components/liquid-dropdown-menu.json`   | Storybook + inventory       |
...
| `LiquidSearchBox`        | `searchbox`       | `form`       | `form`         | `src/components/LiquidSearchBox.tsx`        | `stories/LiquidSearchBox.stories.tsx`        | `registry/components/liquid-searchbox.json`       | Storybook + inventory       |
| `LiquidSelect`           | `select`          | `control`    | `control`      | `src/components/LiquidSelect.tsx`           | `stories/LiquidField.stories.tsx`            | `registry/components/liquid-select.json`          | Storybook + inventory       |
...
| `LiquidSidebar`          | `sidebar`         | `navigation` | `navigation`   | `src/components/LiquidSidebar.tsx`          | `stories/LiquidSidebar.stories.tsx`          | `registry/components/liquid-sidebar.json`         | Storybook + inventory       |
...
| `LiquidSlider`           | `slider`          | `control`    | `control`      | `src/components/LiquidSlider.tsx`           | `stories/LiquidSlider.stories.tsx`           | `registry/components/liquid-slider.json`          | Storybook + inventory       |
...
| `LiquidSwitch`           | `switch`          | `control`    | `control`      | `src/components/LiquidSwitch.tsx`           | `stories/LiquidSwitch.stories.tsx`           | `registry/components/liquid-switch.json`          | Storybook + inventory       |
...
| `LiquidTabs`             | `tabs`            | `navigation` | `navigation`   | `src/components/LiquidTabs.tsx`             | `stories/LiquidTabs.stories.tsx`             | `registry/components/liquid-tabs.json`            | Storybook + inventory       |
...
1. Form and control components: inputs, select, checkbox, switch, slider, toggle,
   combobox, searchbox, and date controls.
2. Overlay and navigation components: dialog-adjacent primitives, menus, tabs,
