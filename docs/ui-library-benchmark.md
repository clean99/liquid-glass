...
| Component page standard    | Component docs repeat install, usage, anatomy, API, states, accessibility, and gates. | `docs/component-documentation.md`, `docs/components/index.md`, component inventory, visual-state coverage, stories.  | Gate-backed                           | `pnpm test:docs`, `pnpm test:governance`              |
