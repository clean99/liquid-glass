...
| -------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------- | ----------------------------------------------------- |
| First screen               | README routes users to docs, install, contributing, security, and releases.     | `README.md`, `docs/installation.md`, `docs/open-source-release.md`, `SECURITY.md`.                          | Gate-backed                           | `pnpm test:docs`, `pnpm test:governance`              |
