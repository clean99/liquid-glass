...
| Written component pages | `docs/components/index.md` links Provider, Surface, Button, Card, Field, Dialog, Accordion, Alert, AlertDialog, Avatar, Badge, Breadcrumb, Calendar, Checkbox, Combobox, DatePicker, DropdownMenu, SearchBox, Select, Sidebar, Slider, Switch, and Tabs pages. | Expanded                        |
