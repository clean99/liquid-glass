...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Per-component written pages are partial  | Users can scan every implemented component in `docs/components/map.md`, but many components still rely on stories and inventory for full detail. | Continue extending `docs/components/` beyond the 33 full pages now covering Provider, Surface, Accordion, Alert, AlertDialog, Avatar, Badge, Breadcrumb, Button, ButtonGroup, Calendar, Card, Checkbox, Combobox, DatePicker, Dialog, DropdownMenu, Field, Input, InputGroup, InputOtp, Label, NativeSelect, RadioGroup, SearchBox, Select, Sidebar, Slider, Switch, Tabs, Textarea, Toggle, and ToggleGroup. |
